...
resumeForm.addEventListener('submit', function (e) {
    ...
    resumeSection.innerHTML = "\n        <h2 contenteditable=\"true\" id=\"name\">".concat(name, "</h2>\n        <p contenteditable=\"true\" id=\"email\">Email: ").concat(email, "</p>\n        <p contenteditable=\"true\" id=\"phone\">Phone: ").concat(phone, "</p>\n\n        <h3>Education</h3>\n        <p contenteditable=\"true\" id=\"education\">").concat(degree, " - ").concat(institution, " (").concat(graduationYear, ")</p>\n\n        <h3>Work Experience</h3>\n        <p contenteditable=\"true\" id=\"jobTitle\"><strong>").concat(jobTitle, "</strong> at ").concat(company, "</p>\n        <p contenteditable=\"true\" id=\"jobDescription\">").concat(jobDescription, "</p>\n\n        <h3>Skills</h3>\n        <ul id=\"skills-list\">\n            ").concat(skills.map(function (skill) { return "<li contenteditable=\"true\">".concat(skill.trim(), "</li>"); }).join(''), "\n        </ul>\n    ");
